...
public class HighestProfitKadane {
    ...
    public static int maxProfit(int[] profits) {
        ...
        for (int i = 1; i < profits.length; i++) {
            // At each day, we decide whether to add the current day's profit to the
            // existing continuous period
    ...
    public static void printMostProfitableDay(int[] profits) {
        ...
        System.out.println("The single MOST profitable day was Day " + (bestDayIndex + 1) + " with a profit of "
                + maxProfit + ".");
    }
